...
(function (BuildingType) {
    ...
    BuildingType["FARMLAND"] = "farmland";
    BuildingType["LIVESTOCK_PEN"] = "livestock_pen";
    BuildingType["PROCESSING_WORKSHOP"] = "processing_workshop";
...
// 获取建筑升级到下一级的消耗
export function getBuildingUpgradeCost(type, currentLevel) {
